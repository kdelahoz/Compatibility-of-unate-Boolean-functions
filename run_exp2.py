# -*- coding: utf-8 -*-
"""
Reproducible experimental runner for Experiment 2.

This script:
- reads datasets from Data/exp2,
- runs Algorithm 1 on each dataset,
- writes only raw per-instance results to Results/raw_exp2.csv.
"""
...
RAW_OUTPUT = RESULTS_DIR / "raw_exp2.csv"
                ...
                for tb in range(1, TB + 1):
                    ...
                    try:
                        ...
                        D, Sigma, info = coverage_algorithm(
                            F0, F1, n, k_max=None, seed=d_seed, prune=True
                        )
